...
export declare class TrackController {
    ...
    delete(id: ObjectId): Promise<import("mongoose").ModifyResult<import("mongoose").Document<unknown, {}, import("./schemas/track.schema").TrackDocument> & import("./schemas/track.schema").Track & import("mongoose").Document<any, any, any> & {
