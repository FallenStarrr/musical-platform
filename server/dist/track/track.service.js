...
let TrackService = class TrackService {
    ...
    async create(dto, picture, audio) {
        ...
        const picPath = this.fileService.createFile(file_service_1.FileType.IMAGE, picture);
        const track = await this.trackModel.create({ ...dto, listens: 0, audio: audioPath, picture: picPath });
        return track;
    }
